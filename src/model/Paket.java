...
public class Paket {
    ...
    public Paket(String no_resi, String nama_pengirim, String nama_penerima,
                 String alamat_tujuan, String jenis_layanan, double berat_kg,
                 double total_biaya, int id_kurir) {
    ...
    public Paket(String no_resi, String nama_pengirim, String nama_penerima,
                 String alamat_tujuan, String jenis_layanan, double berat_kg,
                 double total_biaya, int id_kurir, String nama_kurir) {
        this(no_resi, nama_pengirim, nama_penerima, alamat_tujuan,
